    ...
    <html lang="es-UY" className={`${inter.variable} ${raleway.variable} ${michroma.variable} ${neueHaas.variable}`}>
      <body className="bg-background text-text-primary antialiased">
        ...
        <a
          ...
          className="fixed bottom-6 right-6 z-40 w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:scale-105 transition-transform"
